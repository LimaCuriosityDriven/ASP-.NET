...
builder.Services.AddScoped<IGarbageCollectedService, GarbageCollectedService>();
...
builder.Services.AddScoped(typeof(IGarbageCollectedRepository), typeof(GarbageCollectedRepository));
