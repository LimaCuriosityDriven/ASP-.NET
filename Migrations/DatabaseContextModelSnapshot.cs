...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestaoDeResiduos.Models.GarbageCollectedModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
                    ...
                    b.Property<int>("CollectionDayId")
                        .HasColumnType("NUMBER(10)")
                        .HasColumnName("COLLECTION_DAY_ID");

                    b.HasKey("Id");

                    b.HasIndex("CollectionDayId");

                    b.ToTable("GARBAGE_COLLECTED", (string)null);
                });
            ...
            modelBuilder.Entity("GestaoDeResiduos.Models.GarbageCollectedModel", b =>
                {
                    b.HasOne("GestaoDeResiduos.Models.CollectionDayModel", "CollectionDay")
                        .WithMany()
                        .HasForeignKey("CollectionDayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CollectionDay");
                });
